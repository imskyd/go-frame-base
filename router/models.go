...
type Users struct {
	...
	EmailVerified int        `gorm:"column:email_verified;type:tinyint;default:0;not null" json:"email_verified"`
...
type UsersSub struct {
	Id            int64  `gorm:"column:id" json:"id,omitempty"`
	UserIdMain    int64  `gorm:"column:user_id_main;default:0;not null;type:int" json:"user_id_main,omitempty"`
	Channel       string `gorm:"column:channel;size:20;default:''not null" json:"-"`
	Sub           string `gorm:"column:sub;size:80;default:''not null" json:"-"`
	EmailVerified int    `gorm:"column:email_verified;type:tinyint;default:0;not null" json:"-"`
}
...
type Team struct {
	Id          int64      `gorm:"column:id" json:"id"`
	DisplayName string     `gorm:"column:display_name;size:100;default:''not null" json:"display_name" binding:"required"`
	Handle      string     `gorm:"column:handle;size:100;default:''not null" json:"handle" binding:"required"`
	UserId      int64      `gorm:"column:user_id;default:0;not null;type:int" json:"user_id"`
	Twitter     string     `gorm:"column:twitter;size:300;default:''not null" json:"twitter"`
	Telegram    string     `gorm:"column:telegram;size:300;default:''not null" json:"telegram"`
	Discord     string     `gorm:"column:discord;size:300;default:''not null" json:"discord"`
	Bio         string     `gorm:"column:bio;size:1000;default:''not null" json:"bio"`
	CreatedAt   *time.Time `gorm:"column:created_at;default:CURRENT_TIMESTAMP;not null" json:"-"`
	UpdatedAt   *time.Time `gorm:"column:updated_at;default:CURRENT_TIMESTAMP;not null" json:"-"`
	DeletedAt   *time.Time `gorm:"column:deleted_at" json:"-"`
}
...
type TeamUser struct {
	Id          int64          `gorm:"column:id" json:"id,omitempty"`
	TeamId      int64          `gorm:"column:team_id;default:0;not null;type:int" json:"team_id" binding:"required"`
	Team        Team           `json:"team,omitempty" gorm:"foreignKey:TeamId;references:Id"`
	UserId      int64          `gorm:"column:user_id;default:0;not null;type:int" json:"user_id,omitempty" binding:"required"`
	User        PublicUser     `json:"user,omitempty" gorm:"foreignKey:UserId;references:Id"`
	Role        Role           `gorm:"column:role;size:20;default:''not null" json:"role" binding:"required"`
	Status      TeamUserStatus `gorm:"column:status;size:15;default:''not null" json:"status,omitempty"`
	InviteEmail string         `gorm:"column:invite_email;size:300;default:''not null" json:"-"`
	InviteCode  string         `gorm:"column:invite_code;size:50;default:''not null" json:"-"`
	ExpireAt    int64          `gorm:"column:expire_at;default:0;not null;type:int" json:"-"`
	CreatedAt   *time.Time     `gorm:"column:created_at;default:CURRENT_TIMESTAMP;not null" json:"-"`
	UpdatedAt   *time.Time     `gorm:"column:updated_at;default:CURRENT_TIMESTAMP;not null" json:"-"`
	DeletedAt   *time.Time     `gorm:"column:deleted_at" json:"-"`
}
